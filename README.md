...
```bash
codex plugin marketplace add FutrixDev/futrixdata-codex-plugin --ref v0.1.0
```
...
The first public tag should be `v0.1.0` after the matching FutrixData Desktop release supports the Codex status and authorization flow.
